 ...
 */
@WebServlet("/FiltreRechercheNonConnect")
public class FiltreRechercheCategoriesNonConnecterServlet extends HttpServlet {
	 ...
	 */
	public FiltreRechercheCategoriesNonConnecterServlet() {
		super();
